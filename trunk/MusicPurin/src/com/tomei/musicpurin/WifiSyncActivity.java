...
public class WifiSyncActivity extends Activity
{
    ...
    private ArrayList readAllSyncableFiles() {
        DataInputStream in;
        ...
        try {
            ...
            while (true) {
                String s = in.readUTF();
                if (s.equals(WifiServer.INFO_END_FILES)) {
                    break;
                }
                list.add(s);
            }
    ...
    private void saveToFile(DataInputStream in, int total, int checksum, String fileName) throws IOException {
