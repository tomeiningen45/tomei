...
namespace eval cargurus {
	...
	set terms {
	    ...
	    # All Nissans
	    &distance=100&maxPrice=30000&entitySelectingHelper.selectedEntity=m12
	    # All Mazdas
	    ...
	    # All Mitsubishi
	    &distance=100&maxPrice=30000&entitySelectingHelper.selectedEntity=m46
	    # All Volvo
	    &distance=100&maxPrice=30000&entitySelectingHelper.selectedEntity=m56
	}
